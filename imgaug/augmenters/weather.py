...
class Clouds(meta.SomeOf):
    ...
    **Supported dtypes**:
    ...
    def __init__(
            self,
            seed=None, name=None,
            intensity_mean1=(196, 255),
            intensity_mean2=(196, 255),
            intensity_freq_exponent1=(-2.5, -2.0),
            intensity_freq_exponent2=(-2.0, -1.0),
            intensity_coarse_scale1=10,
            intensity_coarse_scale2=10,
            alpha_min1=0,
            alpha_min2=0,
            alpha_multiplier1=(0.25, 0.75),
            alpha_multiplier2=(0.5, 1.0),
            alpha_size_px_max1=(2, 8),
            alpha_size_px_max2=(64, 128),
            alpha_freq_exponent1=(-2.5, -2.0),
            alpha_freq_exponent2=(-2.0, -1.0),
            sparsity1=(0.8, 1.0),
            sparsity2=(1.0, 1.4),
            density_multiplier1=(0.5, 1.0),
            density_multiplier2=(0.8, 1.5),
            random_state="deprecated", deterministic="deprecated"
        ):
        layers = [
            CloudLayer(
                intensity_mean=intensity_mean1,
                intensity_freq_exponent=intensity_freq_exponent1,
                intensity_coarse_scale=intensity_coarse_scale1,
                alpha_min=alpha_min1,
                alpha_multiplier=alpha_multiplier1,
                alpha_size_px_max=alpha_size_px_max1,
                alpha_freq_exponent=alpha_freq_exponent1,
                sparsity=sparsity1,
                density_multiplier=density_multiplier1,
                seed=seed,
                random_state=random_state,
                deterministic=deterministic
            ),
            CloudLayer(
                intensity_mean=intensity_mean2,
                intensity_freq_exponent=intensity_freq_exponent2,
                intensity_coarse_scale=intensity_coarse_scale2,
                alpha_min=alpha_min2,
                alpha_multiplier=alpha_multiplier2,
                alpha_size_px_max=alpha_size_px_max2,
                alpha_freq_exponent=alpha_freq_exponent2,
                sparsity=sparsity2,
                density_multiplier=density_multiplier2,
                seed=seed,
                random_state=random_state,
                deterministic=deterministic
            )
